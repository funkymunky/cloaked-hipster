...
<%@ include file="/WEB-INF/jsp/include/navbar.jsp" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10">
            <legend>Formerly sponsored students</legend>

                <a href="/lsf/report/formerlySponsored/school"><button type="button" class="btn btn-primary" id="filterSchool">Filter by school</button></a>
                <a href="/lsf/report/formerlySponsored/university"><button type="button" class="btn btn-primary" id="filterUniversity">Filter by university</button></a>
                <a href="#">
    ...
    $(function(){
        $('#filterBank').click(function() {
            ...
            if (!bankName.trim()) {
                ...
                anchor.attr("href", "/lsf/report/formerlySponsored/bank/"+bankName);
            }
        })
    })
</script>
